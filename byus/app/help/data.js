    ...
    articles: [
      {
        ...
        a: "ByUs's standard all-in platform fee starts at 13% of each payment. When a non-founding creator reaches $2,000 in gross ByUs earnings during a calendar month, the rate drops to 10% for the rest of that month, then resets at the start of the next month until the threshold is reached again. The first 50 founding creators, who must be in the US, lock in 10% for good. Any creator who reaches $10,000 in a month pays 9% for the rest of that month. Memberships, tips, and paid downloads all count toward both thresholds. That rate covers standard domestic and cross-border processing — ByUs absorbs Stripe's international-card and currency-conversion surcharges, so the fee doesn't change based on where a fan's card is from. Instant payouts, taxes, disputes, and other exceptional processor costs may still apply separately and will be disclosed where applicable.",
      },
      {
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        a: 'Yes. The original platform does not matter if you have the video file and the right to reuse it. Videos can be up to 30 minutes and 2 GB each; you can upload files up to 4K, and they play in up to 1080p HD. Each creator gets 10 hours of video storage to start, plus 1 more hour for every paying member (up to 200 hours), and deleting a video frees up its time. From the Posts card on your creator dashboard, choose an MP4, MOV, WebM, or M4V file from your device—whether it is your original TikTok or YouTube upload, a phone recording, or an edited export. You can upload one video with a new post or use “Bring over several videos” to queue up to five files. You choose the title, caption, and audience for each. For safety and payment-processor compliance, every video remains hidden while ByUs checks it; approved videos are published, while prohibited videos are rejected and removed. ByUs cannot pull a video from a TikTok or YouTube link or automatically copy an entire channel or library.',
      },
      {
