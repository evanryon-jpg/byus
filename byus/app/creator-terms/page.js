    ...
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <div className="mt-10 space-y-8 text-[15px] leading-relaxed text-brand-ink/85">
        ...
        <Section title="7. Moderation and cooperation">
          <p>You will follow the Content Policy and cooperate with reasonable investigations. ByUs may screen, review, restrict, remove, preserve, or report content and may suspend features, sales, or accounts when we reasonably believe a violation, fraud, safety risk, legal obligation, or payment risk exists. Automated screening can make mistakes; reporting and appeal channels remain available.</p>
        </Section>
