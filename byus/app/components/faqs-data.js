...
export const FAQS = [
  ...
  },
  {
    ...
    a: "Founding spots are open now, and creator accounts open soon. Founding spots are for creators in the US. Reserving one is free and locks in the 10% rate for good; your confirmation shows your spot number. Creator accounts open in the US first, with the UK, Europe and Canada next. When they open, 50 more international founding spots open at 11% for good, offered in the order creators joined the list, so creators there can join now to be first in line. When accounts open, we'll email you a link, and you create your creator account with the same email to claim it. If all 50 spots are reserved, you can still join for updates at standard pricing. Fans, you're all set: sign up and subscribe as normal in the meantime. Creating a ByUs account is free either way; Stripe separately reviews every connected account and may ask for verification info before it'll turn on payments or payouts.",
  },
  {
  ...
  },
  {
    ...
    a: "Nope — setting up your page costs nothing, with zero listing fees and zero setup fees. We only make money when you do. The standard all-in fee starts at 13% and drops to 10% for the rest of a calendar month after $2,000 in gross ByUs earnings. US creators with a reserved founding spot lock in 10% forever.",
  },
  {
