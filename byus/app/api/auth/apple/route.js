...
export async function GET(request) {
  ...
  // paused (see lib/creator-signup.js), a first-time Apple signup can only ever create a
  // fan account, whatever role was requested — app/signup/page.js no longer offers a
  // "Continue with Apple" button on the creator tab, but this is the server-side
